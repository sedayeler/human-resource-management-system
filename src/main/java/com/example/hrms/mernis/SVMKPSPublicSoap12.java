...
public class SVMKPSPublicSoap12
{
    ...
    public SVMKPSPublicSoap12()
    {
    }

    public SVMKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public SVMKPSPublicSoap12 (String url,SVMConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        SVMRequestResultHandler handler = new SVMRequestResultHandler(SVMSoapVersion.v1_2);
        return handler;
    }
